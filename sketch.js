...
balloon.scale = 0.2;
//balloon.debug = true;
balloon.setCollider("circle",0,0,20);
balloon.debug = true;
...
if(balloon.isTouching(bottomGround)|| balloon.isTouching(topGround)|| topObstaclesGroup.isTouching(balloon)|| bottomObstaclesGroup.isTouching(balloon))
{
